                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            <div className="text-right hidden sm:block">
                                ...
                                <p className="text-sm font-bold text-slate-700 max-w-[160px] truncate">
                        ...
                        {dropdownOpen && workspaces.length > 1 && (
                            <div className="absolute right-0 top-full mt-2 w-64 bg-white border border-border rounded-lg shadow-lg z-50 py-1">
                                ...
                                {workspaces.map((ws) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-medium text-slate-700 truncate">{ws.name}</p>
