          ...
          <div className="space-y-16">
            {stages.map((stage, i) => {
              ...
              return (
                ...
                >
                  <AnimateOnScroll animation={reversed ? "fadeRight" : "fadeLeft"} className={reversed ? "lg:order-2" : ""}>
                    <div>
                  ...
                  {/* Visual panel */}
                  <AnimateOnScroll animation={reversed ? "fadeLeft" : "fadeRight"} delay={120} className={`${reversed ? "lg:order-1" : ""} w-full h-full flex`}>
                    <div
                      className="rounded-2xl relative overflow-hidden bg-[#040914] flex items-center justify-center flex-1 w-full"
                      style={{
