  ...
  return (
    <>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <p className="text-xs mb-3" style={{ color: "#64748B" }}>
                    For general enquiries, partnerships, or support
                  </p>
                  <a
                    href="mailto:hello@leadpilot.io"
                    className="text-sm font-medium text-link-teal"
                  >
                    hello@leadpilot.io
                  </a>
                </div>
                ...
                >
                  ...
                  <p className="text-xs" style={{ color: "#64748B" }}>
                    A 20-minute walkthrough of LeadPilot on your actual workflow. No slides.
                    No generic decks.
                  </p>
                </div>
                ...
                >
                  ...
                  <ul className="space-y-2">
                    {[
                      "We map LeadPilot to your current inbound flow",
                      "Live walkthrough — no recorded slides",
                      "Q&A on your specific use case",
                      "Access to Free plan immediately after",
                    ].map((item) => (
                      <li
                        key={item}
      ...
      <section
        ...
        aria-label="Contact reassurance"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
