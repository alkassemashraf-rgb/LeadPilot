...
const values = [
  {
    ...
    description:
      "A lead that waits three hours is a lead that's already talking to your competitor. We obsess over time-to-response because that's where most pipeline is lost.",
  },
  {
    icon: Target,
    title: "Precision over volume",
    description:
      "More leads aren't always better. Better qualification means your team spends time on prospects who will actually close. We're built for yield, not noise.",
  },
  {
    icon: TrendingUp,
    title: "Revenue impact, not activity",
    description:
      "We don't measure success by features shipped. We measure it by the pipeline our customers close. That's the only metric that matters.",
  },
  {
    icon: Shield,
    title: "Trust through transparency",
    description:
      "Full audit logs, clear data handling, honest pricing, and no surprise overages. We earn long-term trust by being straightforward from day one.",
  },
];
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            We exist because
            <br />
            <span className="gradient-text">leads deserve better.</span>
          </h1>
          <p
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Visual trust statement */}
            <div
              className="rounded-2xl p-8"
              style={{ background: "#0E1826", border: "1px solid rgba(15,118,110,0.25)" }}
            ...
            >
              ...
              <blockquote>
                <p
                  className="text-xl font-semibold text-white leading-relaxed mb-6"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {values.map(({ icon: Icon, title, description }) => (
              <div
                key={title}
                className="rounded-xl p-8 value-card-dark"
              >
                <div
            ...
            {[
              {
                ...
                body: "Your lead data belongs to you. Export it at any time, in full. We don't make leaving artificially difficult.",
              },
              {
                title: "Privacy by design",
                body: "Lead data is processed with strict access controls, encryption at rest and in transit, and full audit logging of every access event.",
              },
              {
                title: "Honest communication",
                body: "We won't hide problems behind jargon or hide pricing in footnotes. If something breaks, we'll tell you. If pricing changes, you'll know in advance.",
              },
            ].map(({ title, body }) => (
              <div
                key={title}
